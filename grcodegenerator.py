...
qr = qrcode.QRCode(
  ...
  border=5 # it is the white part of the image --  border in all 4 sides white color
 )
data ="https://accesfinance.africa/"
# as i have given the path of my channel like the same way you give anything 
